...
int main() {
    ...
    float densidadeDemografica1; //O resultado da divisão da população pela área (hab/km²).
    float PIBperCapita1; //O resultado da divisão do PIB pela população.
    ...
    float densidadeDemografica2; //O resultado da divisão da população pela área (hab/km²).
    float PIBperCapita2; //O resultado da divisão do PIB pela população.
    ...
    //Calcular Densidade Demogáfica e PIB per capita de Recife.
    float densidadeDemografica1 = (float)populacao1 / area1;
    PIBperCapita1 = (PIB1 * 1000000) / (float)populacao1; //Multiplicar o PIB por 1.000.000 para converter para R$.
    ...
    float PIBperCapita2 = (PIB2 * 1000000 )/ (float)populacao2; //Multiplicar o PIB por 1.000.000 para converter para R$.

    printf("Densidade demografica de Salvador: %.2f\n", densidadeDemografica2);
    printf("PIB per capita de Salvador em R$: %.2f\n", PIBperCapita2);  

    //Comparar a Densidade Populacional entre Recife e Salvador.
    if (densidade1 > densidadePopulacional2) {
